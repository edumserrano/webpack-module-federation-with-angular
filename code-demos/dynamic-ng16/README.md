...
On the [webpack configuration file for mfe1 app](/code-demos/dynamic-ng16/mfe1-ng16/webpack.config.js) you will find the declaration of the webpack modules to expose:
